...
- (void)getPlayStateWithSuccess:(MediaPlayStateSuccessBlock)success failure:(FailureBlock)failure
{
    if (!self.service.castMediaControlChannel.mediaStatus)
    {
        ...
        MediaControlPlayState playState;
        switch (self.service.castMediaControlChannel.mediaStatus.playerState)
        {
            case GCKMediaPlayerStateIdle:
                if (self.service.castMediaControlChannel.mediaStatus.idleReason == GCKMediaPlayerIdleReasonFinished)
                    playState = MediaControlPlayStateFinished;
                else
                    playState = MediaControlPlayStateIdle;
                break;
...
//    if(self.service.castMediaControlChannel.mediaStatus.mediaInformation.contentID)
//        [mediaMetaData setObject:self.service.castMediaControlChannel.mediaStatus.mediaInformation.contentID forKey:@"contentId"];
    if(self.service.castMediaControlChannel.mediaStatus.mediaInformation.contentType)
        [mediaMetaData setObject:self.service.castMediaControlChannel.mediaStatus.mediaInformation.contentType forKey:@"mimetype"];
...
//- (int)getIndexAudioTrackwithLanguage:(NSString *)language{
//    int index = -1;
//    int nb=0;
//    for(id track in self.tracks){
//        if([track isKindOfClass:[HSSCastPlayerTrack class]]){
//            HSSCastPlayerTrack* hssTrack = (HSSCastPlayerTrack*) track;
//            NSRange rangetype = [hssTrack.mimeType rangeOfString:@"audio/"];
//            if(rangetype.location !=NSNotFound ){
//                if([hssTrack.language isEqualToString:language]){
//                    index = nb;
//                    break;
//                }
//            }
//        }
//        
//        if([track isKindOfClass:[OCKSmoothStreamTrack class]]){
//            OCKSmoothStreamTrack* ockTrack = (OCKSmoothStreamTrack*) track;
//            if(ockTrack.type == OCKMediaTrackTypeAudio){
//                if([ockTrack.languageCode isEqualToString:language]){
//                    index = nb;
//                    break;
//                }
//            }
...
//}
//
//- (int)getIndexSubTrackwithLanguage:(NSString *)language{
//    int index = -1;
//    int nb=0;
//    for(id track in self.tracks){
//        if([track isKindOfClass:[HSSCastPlayerTrack class]]){
//            HSSCastPlayerTrack* hssTrack = (HSSCastPlayerTrack*) track;
//            NSRange rangetype = [hssTrack.mimeType rangeOfString:@"text/"];
//            if(rangetype.location !=NSNotFound ){
//                if([hssTrack.language isEqualToString:language]){
//                    index = nb;
//                    break;
...
//        if([track isKindOfClass:[OCKSmoothStreamTrack class]]){
//            OCKSmoothStreamTrack* ockTrack = (OCKSmoothStreamTrack*) track;
//            if(ockTrack.type == OCKMediaTrackTypeText){
//                if([ockTrack.languageCode isEqualToString:language]){
//                    index = nb;
//                    break;
//                }
...
//}
//
//- (int)getIndexVideoTrack{
//    int index = -1;
//    int nb=0;
//    for(id track in self.tracks){
//        if([track isKindOfClass:[HSSCastPlayerTrack class]]){
//            HSSCastPlayerTrack* hssTrack = (HSSCastPlayerTrack*) track;
//            NSRange rangetype = [hssTrack.mimeType rangeOfString:@"video/"];
//            if(rangetype.location !=NSNotFound ){
//                index = nb;
//                break;
//            }
...
//        if([track isKindOfClass:[OCKSmoothStreamTrack class]]){
//            OCKSmoothStreamTrack* ockTrack = (OCKSmoothStreamTrack*) track;
//            if(ockTrack.type == OCKMediaTrackTypeVideo){
//                index = nb;
//                break;
//            }
//        }
